...
API_PUBLISHABLE_KEY = 'ISPubKey_test_55f4bee9-0690-479a-9f0a-29f281eef519'

API_TOKEN = 'ISSecretKey_test_119011fc-1fb6-44fa-a1c3-73c85b6ff32f'
...
def place_order():
    ...
    if customer_cart:
        try:
            ...
            create_order_response = service.collect.mpesa_stk_push(phone_number='2548037509542', email='olalekanahmed6@gmail.com',
